# IOTA Pico Framework Tutorials - getNodeInfo using Browserify

## Introduction

This tutorial will demonstrate using the the getNodeInfo API from the all-in-one library loaded with Browserify.

## Installation

We are going to run the code for this tutorial in the browser, we will use Browserify as the module loader.
