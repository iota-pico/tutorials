...
(async function () {
    ...
    try {
        const transactions = [ 
            data.Hash.create(data.Trytes.create("V9MSZLPEDELSILGWDWXIZVK9SMYQ9FRFIUCQ9TTHQXEPCXTTAJCRKDCAXNFDDLIOIULKBVRJM9NMZ9999")),
            data.Hash.create(data.Trytes.create("JMECUJIFAQKYCPMPRATVEFLAKHLHBRFHSJXUKQSZNZCEXVG9EANYIGHBVUTXLBNRCHXLCPT9MPKCA9999")),
            data.Hash.create(data.Trytes.create("THENWGPTAPZIIDWHQJ9GREHOVPXNTFWTSTEUGMBPHCHVPGPCEOLGHKZWH9FKACAUIMXJIAFVN9TJZ9999"))
        ];
